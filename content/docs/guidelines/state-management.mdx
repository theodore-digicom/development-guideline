...
### The Right Tool: `react-hook-form`
...
### The Right Tool: `Zustand`

For managing application state, we recommend **`Zustand`**.
...
### The Right Tool: `React Query`

For managing server state, we use **`React Query`**.
